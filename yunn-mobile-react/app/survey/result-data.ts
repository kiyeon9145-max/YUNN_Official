...
export type BalanceKey = 'hydration' | 'barrier' | 'pigment' | 'calmness' | 'oil' | 'environment'
...
const COPY_VARIANTS: Record<string, {
  focus: string; typeSuffix: string; concernKeyword: string; summary: string
  serumName: string; serumTag: string; serumDesc: string; serumWhy: string
}> = {
  Acne: {
    ...
    serumName: 'Brightening Serum', serumTag: 'Treat',
  ...
  Marks: {
    ...
    serumName: 'Tone Repair Serum', serumTag: 'Repair',
  ...
  Pigmentation: {
    ...
    serumName: 'Brightening Serum', serumTag: 'Brighten',
  ...
  Tone: {
    ...
    serumName: 'Even Tone Essence', serumTag: 'Glow',
...
const SKIN_VARIANTS: Record<string, {
  typePrefix: string; keyword: string
  balanceAdjust: Partial<Record<BalanceKey, number>>
  cleanserDesc: string; cleanserWhy: string; moisturiserName: string
}> = {
  Oily: {
    typePrefix: 'Oil-Control', keyword: 'Oily',
  ...
  Dry: {
    typePrefix: 'Hydration', keyword: 'Dry',
  ...
  Combination: {
    typePrefix: 'Dual-Zone', keyword: 'Combination',
  ...
  Normal: {
    typePrefix: 'Sensitive Glow', keyword: 'Balanced',
  ...
  Object.keys(COPY_VARIANTS).forEach(concernType => {
    ...
    RESULT_RECOMMENDATION_CONFIG[`${skinType}|${concernType}`] = {
      ...
      routines: {
        morning: [
          {
            name: 'Gentle Cleanser', tag: 'Cleanse', imageSrc: RESULT_ASSETS.cleanser,
            description: skin.cleanserDesc, why: skin.cleanserWhy,
          ...
          {
            name: concern.serumName, tag: concern.serumTag, imageSrc: RESULT_ASSETS.serum,
            description: concern.serumDesc, why: concern.serumWhy,
            how: 'Apply 2-3 drops on your face and gently pat until fully absorbed.',
            tip: concernType === 'Pigmentation'
              ? 'Use consistently with sunscreen to protect brightening progress.'
              : 'Focus on areas that need the most support.',
          },
          {
            name: 'Daily Sunscreen', tag: 'Protect', imageSrc: RESULT_ASSETS.sunscreen,
        ...
        evening: [
          ...
          {
            name: concern.serumName, tag: 'Repair', imageSrc: RESULT_ASSETS.serum,
            description: concern.serumDesc, why: concern.serumWhy,
          ...
          {
            name: skin.moisturiserName, tag: 'Seal', imageSrc: RESULT_ASSETS.moisturiser,
...
const TYPE_PROFILES: Record<string, Partial<ResultConfig>> = {
  'Oily|Acne':           { skinTypeName: 'Oil Clear',       keywords: ['Oily', 'Acne-prone', 'Sebum Control'],      focus: 'consistent oil control',                                    summary: "Your skin tends to produce more oil than it needs — and in India's heat and humidity, that builds up fast. Lightweight hydration and consistent oil control can help keep your skin clear, calm, and balanced through the day." },
  'Oily|Marks':          { skinTypeName: 'Glow Restore',    keywords: ['Oily', 'Post-acne', 'Repair'],               focus: 'gentle brightening care',                                   summary: 'Your skin is still recovering from past breakouts — and UV exposure can make those marks linger longer than expected. With steady barrier support and gentle brightening care, your skin tone can gradually become clearer and more even.' },
  'Oily|Pigmentation':   { skinTypeName: 'Radiance Shield', keywords: ['Oily', 'Pigmentation', 'UV Defense'],        focus: 'Consistent sunscreen and brightening care',                 summary: 'Your skin may be more reactive to pigmentation triggers — and daily UV exposure makes that harder to manage without the right protection. Consistent sunscreen and brightening care can help prevent dark spots from deepening and keep your natural radiance visible.' },
  'Oily|Tone':           { skinTypeName: 'Glow Balance',    keywords: ['Oily', 'Uneven Tone', 'Glow'],               focus: 'Lightweight hydration and tone-balancing care',             summary: 'Your skin is producing more oil than it needs, and that imbalance is showing up as shine and uneven tone. Lightweight hydration and tone-balancing care can help your skin find its natural rhythm — and bring back its glow.' },
  'Dry|Acne':            { skinTypeName: 'Calm Repair',     keywords: ['Dry', 'Breakout', 'Barrier'],                focus: 'Calming hydration and barrier-focused care',               summary: 'Your skin is dealing with dryness and breakouts at the same time — which happens when the skin barrier becomes weakened and more reactive. Calming hydration and barrier-focused care can help reduce irritation and bring your skin back to a more comfortable balance.' },
  'Dry|Marks':           { skinTypeName: 'Barrier Glow',    keywords: ['Dry', 'Repair', 'Barrier Stress'],           focus: 'Rebuilding your skin barrier',                             summary: 'Your skin is in recovery mode — and without enough moisture, post-acne marks tend to stay more visible and healing feels slower. Rebuilding your skin barrier with gentle, nourishing care can help speed up recovery and bring back a healthy glow over time.' },
  'Dry|Pigmentation':    { skinTypeName: 'Soft Glow',       keywords: ['Dry', 'Pigmentation', 'Dehydrated'],         focus: 'Deep hydration and consistent brightening care',            summary: 'Your skin is low on moisture — and when hydration drops, dark spots and uneven areas tend to look more visible than they actually are. Deep hydration and consistent brightening care can help even out your tone and bring your natural glow back to the surface.' },
  'Dry|Tone':            { skinTypeName: 'Soft Bright',     keywords: ['Dry', 'Hydration', 'Even Tone'],             focus: 'moisture levels are well maintained',                      summary: 'Your skin has natural glow — it just needs more hydration to show it. When moisture levels are well maintained, skin looks noticeably smoother, more even, and more radiant.' },
  'Combination|Acne':    { skinTypeName: 'Clear Harmony',   keywords: ['Combination', 'Acne-prone', 'Oil Balance'],  focus: 'Balanced oil control and lightweight hydration',           summary: 'Your skin runs oily in some areas and feels tight or irritated in others — making breakouts harder to predict and manage. Balanced oil control and lightweight hydration working together can help your skin feel more settled and consistently clearer.' },
  'Combination|Marks':   { skinTypeName: 'Clear Harmony',   keywords: ['Combination', 'Acne-prone', 'Oil Balance'],  focus: 'Balanced oil control and lightweight hydration',           summary: 'Your skin runs oily in some areas and feels tight or irritated in others — making breakouts harder to predict and manage. Balanced oil control and lightweight hydration working together can help your skin feel more settled and consistently clearer.' },
  'Combination|Pigmentation': { skinTypeName: 'Glow Harmony', keywords: ['Combination', 'Uneven Tone', 'Radiance'], focus: 'Tone-balancing care, lightweight hydration, and daily sun protection', summary: "Your skin is dealing with both oil imbalance and uneven tone — and UV exposure makes it harder for your skin to stay bright and balanced. Tone-balancing care, lightweight hydration, and daily sun protection can work together to bring your skin's radiance back into harmony." },
  'Combination|Tone':    { skinTypeName: 'Glow Harmony',    keywords: ['Combination', 'Uneven Tone', 'Radiance'],    focus: 'Tone-balancing care, lightweight hydration, and daily sun protection', summary: "Your skin is dealing with both oil imbalance and uneven tone — and UV exposure makes it harder for your skin to stay bright and balanced. Tone-balancing care, lightweight hydration, and daily sun protection can work together to bring your skin's radiance back into harmony." },
  'Normal|Acne':         { skinTypeName: 'Pure Radiance',   keywords: ['Normal', 'Natural Glow', 'Balanced'],        focus: 'hydration and sun protection',                             summary: 'Your skin is in a genuinely good place — balanced, resilient, and responding well to daily care. Keeping up with hydration and sun protection is what helps your natural radiance stay exactly where it is.' },
  'Normal|Marks':        { skinTypeName: 'Pure Radiance',   keywords: ['Normal', 'Natural Glow', 'Balanced'],        focus: 'hydration and sun protection',                             summary: 'Your skin is in a genuinely good place — balanced, resilient, and responding well to daily care. Keeping up with hydration and sun protection is what helps your natural radiance stay exactly where it is.' },
  'Normal|Pigmentation': { skinTypeName: 'Pure Radiance',   keywords: ['Normal', 'Natural Glow', 'Balanced'],        focus: 'hydration and sun protection',                             summary: 'Your skin is in a genuinely good place — balanced, resilient, and responding well to daily care. Keeping up with hydration and sun protection is what helps your natural radiance stay exactly where it is.' },
  'Normal|Tone':         { skinTypeName: 'Pure Radiance',   keywords: ['Normal', 'Natural Glow', 'Balanced'],        focus: 'hydration and sun protection',                             summary: 'Your skin is in a genuinely good place — balanced, resilient, and responding well to daily care. Keeping up with hydration and sun protection is what helps your natural radiance stay exactly where it is.' },
}
...
export const RESULT_PRODUCTS: ProductItem[] = [
  { id: 'cleanser-foam',   name: 'Anua Heartleaf Pore Deep Cleansing Foam',       imageSrc: RESULT_ASSETS.cleanserCard,  discount: '15%', price: '₹1,500', original: '₹2,000', rating: '4.3', reviews: '1,000' },
  { id: 'niacin-essence',  name: 'Nacific Phyto Niacin Whitening Essence',         imageSrc: RESULT_ASSETS.serumCard,     discount: '20%', price: '₹1,350', original: '₹2,000', rating: '4.5', reviews: '978' },
  { id: 'relief-sun',      name: 'Beauty of Joseon Relief sun SPF50+ PA++++',      imageSrc: RESULT_ASSETS.sunscreenCard, discount: '15%', price: '₹1,500', original: '₹2,000', rating: '4.8', reviews: '975' },
  { id: 'ceramide-cream',  name: 'ILLIYOON Ceramide Ato Concentrate Cream',        imageSrc: RESULT_ASSETS.creamCard,    discount: '15%', price: '₹1,500', original: '₹2,000', rating: '4.5', reviews: '1,002' },
]
...
export function getResultConfig(data: ResultData): ResultConfig {
  ...
  return RESULT_RECOMMENDATION_CONFIG[key] ?? RESULT_RECOMMENDATION_CONFIG['Oily|Acne']
}

export function getBalanceStatus(value: number): 'Good' | 'Needs Care' | 'Focus' {
  if (value >= 78) return 'Good'
  if (value >= 52) return 'Needs Care'
  return 'Focus'
}

export function computeSkinBalance(data: ResultData, config: ResultConfig): BalanceMetric[] {
