...
export default function PhotoStep({ onBack, onComplete, onSkip }: PhotoStepProps) {
  ...
  return (
    <>
      <h2 className="mb-[10px] text-[24px] font-bold leading-[1.17] tracking-[-0.01em] text-black">
        One last step.<br />Let&apos;s <span className="text-primary">track your progress</span>.
      </h2>

      <p className="mb-6 text-[13px] font-normal leading-[1.4] tracking-[-0.2px] text-black">
        Upload a clear photo of your skin in natural lighting.<br />
        ...
        >
          {photoDataUrl ? (
            ...
            <>
              ...
              <div className="mb-1.5 text-[15px] font-bold text-black">Upload your skin photo</div>
      ...
      <div className="mb-8 flex items-center gap-3">
        ...
        <div className="text-xs leading-[1.4] text-[#888]">
          Your photos are private and only used<br />to track your skin progress.
        </div>
      </div>
